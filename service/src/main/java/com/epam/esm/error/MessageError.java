...
public class MessageError {
    ...
    public static final String ERROR_0400155 = "Certificate description less than 5 symbols";
    ...
    public static final String ERROR_0400162 = "Incorrect certificate's ID";
    public static final String ERROR_0400163 = "ID must contains only digit";
